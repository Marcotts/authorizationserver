...
import com.bmdb.security.authorizationserveur.authentication.DeviceClientAuthenticationProvider;
import com.bmdb.security.authorizationserveur.federation.FederatedIdentityIdTokenCustomizer;
import com.bmdb.security.authorizationserveur.jose.Jwks;
import com.bmdb.security.authorizationserveur.web.authentication.DeviceClientAuthenticationConverter;
...
public class AuthorizationServerConfig {
	...
	public JdbcRegisteredClientRepository registeredClientRepository(JdbcTemplate jdbcTemplate) {
		...
		// mTLS client configuration removed as it's not compatible with Spring Security 6.2.1
